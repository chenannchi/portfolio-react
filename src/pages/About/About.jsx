          ...
          {isLanguageEng ?
            ...
            <div className={styles.brandStatement}>
              ...
              <p id={styles.mandarinAbout}>
                &nbsp;&nbsp;&nbsp;&nbsp;畢業於台北醫學大學主修醫務管理學系，跨校輔修北科大資工系。曾於萬芳醫院擔任專案管理實習生，以及商之器科技公司擔任R&D實習生。於商之器科技實習期間，第一次學習如何撰寫及測試網站。
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;畢業後於美國General Assembly Bootcamp全職進修網站開發技術。期間，創建多項專案，Giftology是印象最深刻的團體專案，此網站衷旨為希望藉由建立以及分享自己的願望清單達到貼心送禮以及降低資源浪費。Bootcamp結束後，參與雅詩蘭黛主辦的無障礙美妝網站開發黑客松，目前正在參與另一項美國FDA與民間組織合作的三個月專案，與15位以上的團隊，包含軟體工程師、資料分析師、UX設計師、專案管理師，以及業界專業人士，合作開發一款可以讓使用者保存管理並且分享醫療紀錄的手機APP。
                <br />
                <br />
